...
cap = cv2.VideoCapture(r'C:\Users\saktheeswaran\Desktop\yolo-tinty\dffdfgfh.mp4')
...
while cv2.waitKey(1) < 0:
    ...
    for out in outs: 
        ...
        #each detection  has the form like this [center_x center_y width height obj_score class_1_score class_2_score ..]
            ...
            row1 += 1
            row2 += 1
            sheet.append((class_id, datetime.datetime.strftime(datetime.datetime.now(), "%Y-%m-%d %H:%M:%S")))
